...
public class SettingPopupManager : MonoBehaviour
{
    ...
    public static SettingPopupManager Instance { get; private set; }

    public GameObject SettingCanvas;     // 설정 canvas
